...
| File | Description |
|---|---|
| [01_setup_relationships.sql](./01_setup_relationships.sql) | Database creation and Setting Up table relationships|
| [02_eda.sql](./02_eda.sql) | Exploratory data analysis |
| [03_customer_analysis.sql](./03_customer_analysis.sql) | Customer analysis queries |
| [04_seller_analysis.sql](./04_seller_analysis.sql) | Seller performance queries |
| [05_product_analysis.sql](./05_product_analysis.sql) | Product category queries |
| [06_operational_analysis.sql](./06_operational_analysis.sql) | Operational analysis queries |
| [07_advanced_queries.sql](./07_advanced_queries.sql) | Window functions and advanced queries |
